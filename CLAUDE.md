...
| new-project.md | Existing codebase | .tiki/prompts/new-project/tech-stack-analysis.md |
| new-project.md | Template generation | .tiki/prompts/new-project/project-templates.md |
